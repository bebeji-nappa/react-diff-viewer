    ...
    function DiffViewer(props) {
        ...
        _this.renderWordDiff = function (diffArray, renderer) {
            return diffArray.map(function (wordDiff, i) {
                var _a;
                return (React.createElement("span", { key: i, className: (0, classnames_1.default)(_this.styles.wordDiff, (_a = {},
                        ...
                        _a)) },
                    React.createElement(React.Fragment, null, renderer ? renderer(wordDiff.value) : wordDiff.value)));
            });
        };
        /**
        ...
        _this.renderLine = function (lineNumber, type, prefix, value, additionalLineNumber, additionalPrefix) {
            ...
            return (React.createElement(React.Fragment, null,
                !_this.props.hideLineNumbers && (React.createElement("td", { onClick: lineNumber && _this.onLineNumberClickProxy(lineNumberTemplate), className: (0, classnames_1.default)(_this.styles.gutter, (_a = {},
                ...
                !_this.props.splitView && !_this.props.hideLineNumbers && (React.createElement("td", { onClick: additionalLineNumber &&
                        _this.onLineNumberClickProxy(additionalLineNumberTemplate), className: (0, classnames_1.default)(_this.styles.gutter, (_b = {},
                ...
                React.createElement("td", { className: (0, classnames_1.default)(_this.styles.marker, (_c = {},
                    ...
                    React.createElement("pre", null,
                        added && '+',
                        removed && '-')),
                React.createElement("td", { className: (0, classnames_1.default)(_this.styles.content, (_d = {},
        ...
        _this.renderSkippedLineIndicator = function (num, blockNumber, leftBlockLineNumber, rightBlockLineNumber) {
            ...
            return (React.createElement("tr", { key: "".concat(leftBlockLineNumber, "-").concat(rightBlockLineNumber), className: _this.styles.codeFold },
                !hideLineNumbers && React.createElement("td", { className: _this.styles.codeFoldGutter }),
                React.createElement("td", { className: (0, classnames_1.default)((_a = {},
        ...
        _this.renderDiff = function () {
            ...
            var _b = (0, compute_lines_1.computeLineInformation)(oldValue, newValue, disableWordDiff, compareMethod, linesOffset), lineInformation = _b.lineInformation, diffLines = _b.diffLines;
        ...
        _this.render = function () {
            ...
            var nodes = _this.renderDiff().filter(function (v) { return v !== null && v; });
            ...
            return (React.createElement("table", { className: (0, classnames_1.default)(_this.styles.diffContainer, (_a = {},
                    _a[_this.styles.splitView] = splitView,
                    _a)) },
                React.createElement("tbody", null,
                    title,
                    React.createElement(react_virtuoso_1.Virtuoso, { style: { height: '400px' }, totalCount: nodes.length, itemContent: function (index) { return nodes[index]; } }))));
        };
        _this.state = {
            expandedBlocks: [],
        };
